...
- [x] Show **Top 10+** in the panel, with a **position filter** — **v0.28: All/GK/DEF/MID/ATT filter buttons + U21 toggle on the wonderkids view; positions captured from row cells ("ST (C)", "D/WB (R)")**
